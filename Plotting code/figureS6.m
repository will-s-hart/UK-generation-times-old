% Produce the panels in Figure S6 of our manuscript.
...
load('../Results/Split_data/mcmc_posterior_mech_splitdata.mat','mean_post1','mean_post2','mean_post3','sd_post1','sd_post2','sd_post3','beta_post1','beta_post2','beta_post3')
...
figure(1); export_fig Figures/figureS6/figS6A.pdf -nocrop -painters -transparent
figure(2); export_fig Figures/figureS6/figS6B.pdf -nocrop -painters -transparent
figure(3); export_fig Figures/figureS6/figS6C.pdf -nocrop -painters -transparent
